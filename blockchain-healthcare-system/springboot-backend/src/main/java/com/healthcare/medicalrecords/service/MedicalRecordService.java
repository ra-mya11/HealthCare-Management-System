...
public class MedicalRecordService {
    ...
    public UploadResponse uploadRecord(MultipartFile file, String patientId, 
        ...
        try {
            ...
            String txHash = blockchainService.addRecord(
                recordId, ipfsHash, patientId, doctorId, recordType
            );
    ...
    private RecordDetailsResponse mapToRecordDetails(MedicalRecord record) {
        return RecordDetailsResponse.builder()
            ...
            .status("ACTIVE")
            .expiresAt("2031-01-01 00:00:00")  // Default 7 years from smart contract
            .message("Success")
            .success(true)
            .build();
    }
