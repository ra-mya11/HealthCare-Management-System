...
public class AdminController {
    ...
    public ResponseEntity<Department> createDepartment(@RequestBody Department dept) {
        Department created = adminService.createDepartment(dept);
    ...
    public ResponseEntity<Department> updateDepartment(@PathVariable Long id,
        ...
        Department dept = adminService.updateDepartment(id, updated);
    ...
    public ResponseEntity<DoctorDto> registerDoctor(
        ...
        Doctor doc = adminService.registerDoctor(userId, specialization, experienceYears, departmentId);
    ...
    public ResponseEntity<DoctorDto> updateDoctor(
            ...
            @RequestParam Integer experienceYears,
            @RequestParam(required = false) Long departmentId) {
        Doctor doc = adminService.updateDoctor(userId, specialization, experienceYears, departmentId);
    ...
    // Helper method to get current admin ID from JWT or session
    private Long getCurrentAdminId() {
        // In a real scenario, extract from JWT token or Security context
