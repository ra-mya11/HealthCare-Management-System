...
function Recommendations() {
  ...
  if (!recommendations) {
    return (
      <div className="bg-white rounded-xl shadow-md p-12 text-center">
        ...
        <p className="text-sm text-gray-500 mt-2">Complete a health assessment to get personalized recommendations</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl shadow-md p-6">
        <h3 className="text-xl font-semibold mb-2">🏥 Recommended Department</h3>
        <p className="text-3xl font-bold mb-2">{recommendations.department}</p>
        <p className="opacity-90">Based on your health assessment and risk factors</p>
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        ...
        {recommendations.diet && recommendations.diet.length > 0 ? (
          ...
          <p className="text-gray-600">No specific diet recommendations at this time</p>
        )}
        
        <div className="mt-6 p-4 bg-blue-50 rounded-lg">
          <p className="text-sm font-medium text-blue-900">💡 Pro Tip</p>
          <p className="text-sm text-blue-800 mt-1">
            Maintain a food diary to track your nutrition and share it with your doctor during consultations.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        ...
        {recommendations.exercise && recommendations.exercise.length > 0 ? (
          ...
          <p className="text-gray-600">No specific exercise recommendations at this time</p>
        )}
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 border-2 border-blue-200 rounded-lg">
            ...
            <p className="text-sm text-gray-600 mt-1">Take prescribed medications</p>
          ...
          <div className="p-4 border-2 border-purple-200 rounded-lg">
            ...
            <p className="text-sm text-gray-600 mt-1">30 minutes physical activity</p>
          ...
          <div className="p-4 border-2 border-red-200 rounded-lg">
            ...
            <p className="text-sm text-gray-600 mt-1">Monitor vitals (BP, Sugar)</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm opacity-90">Drink 8 glasses of water daily</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <span className="text-2xl">😴</span>
