...
export const fetchAllUsers = () => axios.get(`${BASE_URL}/admin/users`);
export const getUsersByRole = (role) =>
  axios.get(`${BASE_URL}/admin/users/role/${role}`);
export const approveUser = (userId, enabled) =>
  axios.patch(`${BASE_URL}/admin/users/${userId}/status`, null, {
    params: { enabled },
  });
export const updateUserRole = (userId, role) =>
  axios.patch(`${BASE_URL}/admin/users/${userId}/role`, { role });
...
export const registerDoctor = (
  ...
  axios.post(`${BASE_URL}/admin/doctors`, null, {
    params: { userId, specialization, experienceYears, departmentId },
  });
...
export const updateDoctor = (
  ...
  axios.put(`${BASE_URL}/admin/doctors/${userId}`, null, {
    params: { specialization, experienceYears, departmentId },
  });
